...
(function () {
  ...
  app.service('apiService',
      function (alertService, $http, $log, $location, localStorageService,
        ...
        function simpleCall(method, url, onSuccess, options) {
          var headers = {};
        ...
        this.GET = function (url, onSuccess, options) {
          return simpleCall('GET', url, onSuccess, options);
        };
